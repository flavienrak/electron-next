...
export default function SettingsPage() {
  ...
  return (
    <div className="settings-container">
      ...
      >
        <div className="setting-description">Activer/désactiver les notifications</div>
        <div className="setting-control">
          <Switch onChange={handleNotificationChange} />
        </div>
      </Card>
      <Card title="Mode Nuit" extra={<BulbOutlined />} className="setting-item">
        <div className="setting-description">Activer/désactiver le mode nuit</div>
        <div className="setting-control">
      ...
      >
        <div className="setting-description">Voir l'historique</div>
        <div className="setting-control">
      ...
      >
        <div className="setting-description">Configurer le son</div>
        <div className="setting-control">
      ...
      >
        <div className="setting-description">Voir les informations</div>
        <div className="setting-control">
  ...
  return (
    <div className="settings-container">
      <Card
        ...
        className="setting-item"
      >
        <div className="ant-card-meta-description">Activer/désactiver les notifications</div>
        <div className="ant-card-meta-detail">
          <Switch onChange={handleNotificationChange} />
        </div>
      </Card>
      <Card title="Mode Nuit" extra={<BulbOutlined />} className="setting-item">
        <div className="ant-card-meta-description">Activer/désactiver le mode nuit</div>
        <div className="ant-card-meta-detail">
          <Switch onChange={handleNightModeChange} />
        </div>
      </Card>
